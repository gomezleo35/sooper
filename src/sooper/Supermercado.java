...
public class Supermercado {
	...
	public static void main(String[] args) {
		...
		miPedido.addContenedor(new Caja("C333", 50, 60, 75));
		...
		miPedido.addProducto(new Mascotas("PER1", 10000, 20000));
		miPedido.addProducto(new Mascotas("PER2", 10000, 20000));
		miPedido.addProducto(new Higiene("GEL", 1500, 1600));
		miPedido.addProducto(new Drogueria("DET", 2000, 1600));
		miPedido.addProducto(new Drogueria("LEJ", 1000, 1000));
		
		for(int i = 0; i < 24; i ++){
			miPedido.addProducto(new Fresco("YOG" + i, 250, 300, LocalDate.now().plusDays(i)));
		}
		
		miPedido.addProducto(new NoPerecedero("ARR", 1000, 1000));
		
		for (int i = 0; i < 5; i ++){
			miPedido.addProducto(new NoPerecedero("PAS" + i, 1000, 1200));
		}
